...
module.exports = {
    SESSION_ID: process.env.SESSION_ID || "oLEinbTZ#CJIkuTpbaHnOa161HPvAzp_qq3LBo_M3EcQVK2JqLLw",
    ...
    AUTHOR: (process.env.PACK_INFO?.split(';') || [])[0] || 'ZiDi Malik 012',
    PACKNAME: (process.env.PACK_INFO?.split(';') || [])[1] || '923247116683',
